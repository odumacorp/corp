...
urlpatterns = _html_redirects + [
    ...
    path('landing/v2/', views.index_v2, name='index_v2'),
    path('landing/v3/', views.index_v3, name='index_v3'),
    path('landing/v4/', views.index_v4, name='index_v4'),
    path('landing/v5/', views.index_v5, name='index_v5'),
